...
from dewarp import __version__
...
project = 'dewarp'
copyright = '{0}, {1}'.format('2019', 'Adam Mendenhall')
...
htmlhelp_basename = '{0}pdoc'.format('dewarp')
...
man_pages = [
    (master_doc, 'dewarp', u'{0} Documentation'.format(project),
     [author], 1)
]
