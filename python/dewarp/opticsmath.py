...
def unitize_xys(xys):
    ...
    overshrinks by 1.5 (you shouldn't use this function anyway, you should know the proper radius to scale)
    ...
    """
    r = numpy.max(numpy.square(xys[0::2])+numpy.square(xys[1::2]))
    return numpy.divide(xys, 1.5*numpy.sqrt(r))
